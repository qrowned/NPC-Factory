 ...
 */
public class RotationModifier extends AbstractModifier {

    private RotationModifier(@NotNull NPC npc) {
        super(npc);
    }
     ...
     * @see NPC#rotation()
     */
    public static RotationModifier create(@NotNull NPC npc) {
        return new RotationModifier(npc);
    }
