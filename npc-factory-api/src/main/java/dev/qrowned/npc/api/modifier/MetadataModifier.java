 ...
 */
public class MetadataModifier extends AbstractModifier {
    ...
    private MetadataModifier(@NotNull NPC npc) {
        super(npc);
    }
     ...
     * @see NPC#metadata()
     */
    public static MetadataModifier create(@NotNull NPC npc) {
        return new MetadataModifier(npc);
    }
