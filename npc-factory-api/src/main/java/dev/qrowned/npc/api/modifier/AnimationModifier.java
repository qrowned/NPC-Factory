 ...
 */
public class AnimationModifier extends AbstractModifier {

    private AnimationModifier(@NotNull NPC npc) {
        super(npc);
    }
     ...
     * @see NPC#animation()
     */
    public static AnimationModifier create(@NotNull NPC npc) {
        return new AnimationModifier(npc);
    }
